...
# -------- 6) 导出结果表格 --------
all_results.to_csv("prop_yes_by_week_fixed_BMI5_2.csv", index=False, encoding="utf-8-sig")

print("完成！结果保存到 prop_yes_by_week_fixed_BMI5_2.csv")
