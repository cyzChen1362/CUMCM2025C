...
# === 1. 读取数据 ===
file_path = "男胎检测数据_处理后_filtered.xlsx"  # 输入文件路径
...
# === 5. 输出五个新的表格 ===
group1.to_excel("BMI_group1.xlsx", index=False)
group2.to_excel("BMI_group2.xlsx", index=False)
group3.to_excel("BMI_group3.xlsx", index=False)
group4.to_excel("BMI_group4.xlsx", index=False)
group5.to_excel("BMI_group5.xlsx", index=False)
