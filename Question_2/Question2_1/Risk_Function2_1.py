...
def process_file(file_path, label):
    ...
    weeks = np.arange(w_min, w_max+step, step)   # 遍历小数孕周
    rows = []
    for w in weeks:
...
# ===== 循环处理五个分组文件 =====
files = {
    "Group1": "BMI_group2_1.xlsx",
    "Group2": "BMI_group2_2.xlsx",
    "Group3": "BMI_group2_3.xlsx",
    "Group4": "BMI_group2_4.xlsx",
    "Group5": "BMI_group2_5.xlsx"
}
