...
EXCEL_PATH = r"男胎检测数据_处理后_with_flags_浮动后.xlsx"
...
try:
    ...
    fig.set_constrained_layout(True)   # 避免标题/标签被裁切
    ...
    q_fus_slice = [q_hat(w, bmi0) for w in w_plot]
